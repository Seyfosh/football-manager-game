...
const MARKET_PLAYERS: Player[] = [
  ...
  { id: 316, name: 'Rasmus Hojlund', club: 'Man United', position: 'ST', age: 22, ovr: 80, pace: 86, shooting: 78, passing: 60, dribbling: 72, defending: 36, physical: 78, price: 50000000 },
  { id: 317, name: 'Moises Caicedo', club: 'Chelsea', position: 'CDM', age: 23, ovr: 84, pace: 78, shooting: 64, passing: 78, dribbling: 78, defending: 84, physical: 80, price: 80000000 },
  { id: 318, name: 'Cole Palmer', club: 'Chelsea', position: 'CAM', age: 23, ovr: 86, pace: 80, shooting: 84, passing: 84, dribbling: 88, defending: 48, physical: 66, price: 90000000 },
  { id: 319, name: 'Declan Rice', club: 'Arsenal', position: 'CDM', age: 26, ovr: 88, pace: 75, shooting: 72, passing: 83, dribbling: 79, defending: 89, physical: 87, price: 100000000 },
  { id: 320, name: 'Erling Haaland', club: 'Manchester City', position: 'ST', age: 25, ovr: 91, pace: 97, shooting: 97, passing: 65, dribbling: 80, defending: 45, physical: 88, price: 180000000 },
  { id: 321, name: 'Rodrigo De Paul', club: 'Atletico Madrid', position: 'CM', age: 31, ovr: 82, pace: 74, shooting: 72, passing: 82, dribbling: 78, defending: 78, physical: 78, price: 25000000 },
  { id: 322, name: 'Julian Alvarez', club: 'Atletico Madrid', position: 'ST', age: 25, ovr: 86, pace: 82, shooting: 84, passing: 76, dribbling: 84, defending: 44, physical: 74, price: 75000000 },
  { id: 323, name: 'Nico Williams', club: 'Athletic Bilbao', position: 'LW', age: 23, ovr: 84, pace: 94, shooting: 78, passing: 74, dribbling: 88, defending: 38, physical: 66, price: 60000000 },
  { id: 324, name: 'Federico Chiesa', club: 'Liverpool', position: 'RW', age: 27, ovr: 82, pace: 88, shooting: 80, passing: 72, dribbling: 84, defending: 40, physical: 70, price: 30000000 },
  { id: 325, name: 'Randal Kolo Muani', club: 'Juventus', position: 'ST', age: 26, ovr: 82, pace: 88, shooting: 80, passing: 66, dribbling: 76, defending: 38, physical: 78, price: 45000000 },
  { id: 326, name: 'Teun Koopmeiners', club: 'Juventus', position: 'CM', age: 27, ovr: 82, pace: 70, shooting: 78, passing: 82, dribbling: 78, defending: 74, physical: 76, price: 35000000 },
  { id: 327, name: 'Dusan Vlahovic', club: 'Juventus', position: 'ST', age: 25, ovr: 82, pace: 78, shooting: 84, passing: 62, dribbling: 74, defending: 38, physical: 82, price: 40000000 },
  { id: 328, name: 'Nicolas Jackson', club: 'Chelsea', position: 'ST', age: 24, ovr: 79, pace: 88, shooting: 76, passing: 62, dribbling: 76, defending: 38, physical: 74, price: 45000000 },
  { id: 329, name: 'Amadou Onana', club: 'Aston Villa', position: 'CDM', age: 24, ovr: 79, pace: 74, shooting: 62, passing: 74, dribbling: 74, defending: 80, physical: 84, price: 40000000 },
  { id: 330, name: 'Morgan Rogers', club: 'Aston Villa', position: 'LW', age: 23, ovr: 79, pace: 84, shooting: 74, passing: 74, dribbling: 82, defending: 46, physical: 74, price: 35000000 },
  { id: 331, name: 'Bruno Guimaraes', club: 'Newcastle', position: 'CM', age: 27, ovr: 85, pace: 76, shooting: 74, passing: 84, dribbling: 82, defending: 80, physical: 80, price: 80000000 },
  { id: 332, name: 'Alexander Isak', club: 'Newcastle', position: 'ST', age: 26, ovr: 86, pace: 86, shooting: 86, passing: 70, dribbling: 80, defending: 40, physical: 78, price: 100000000 },
  { id: 333, name: 'Anthony Gordon', club: 'Newcastle', position: 'LW', age: 24, ovr: 81, pace: 90, shooting: 76, passing: 72, dribbling: 82, defending: 42, physical: 70, price: 55000000 },
  { id: 334, name: 'Dominik Szoboszlai', club: 'Liverpool', position: 'CM', age: 24, ovr: 84, pace: 80, shooting: 80, passing: 84, dribbling: 82, defending: 68, physical: 74, price: 65000000 },
  { id: 335, name: 'Ryan Gravenberch', club: 'Liverpool', position: 'CDM', age: 23, ovr: 82, pace: 82, shooting: 66, passing: 78, dribbling: 78, defending: 76, physical: 76, price: 55000000 },
  { id: 336, name: 'Florian Wirtz', club: 'Liverpool', position: 'CAM', age: 22, ovr: 87, pace: 80, shooting: 80, passing: 86, dribbling: 90, defending: 58, physical: 66, price: 100000000 },
  { id: 337, name: 'Hugo Ekitike', club: 'Liverpool', position: 'ST', age: 23, ovr: 81, pace: 84, shooting: 78, passing: 66, dribbling: 76, defending: 38, physical: 76, price: 60000000 },
  { id: 338, name: 'Milos Kerkez', club: 'Liverpool', position: 'LB', age: 21, ovr: 79, pace: 86, shooting: 52, passing: 70, dribbling: 72, defending: 76, physical: 74, price: 40000000 },
  { id: 339, name: 'Jeremie Frimpong', club: 'Liverpool', position: 'RB', age: 24, ovr: 80, pace: 92, shooting: 62, passing: 68, dribbling: 78, defending: 74, physical: 70, price: 45000000 },
  { id: 340, name: 'Bryan Mbeumo', club: 'Man United', position: 'RW', age: 25, ovr: 82, pace: 84, shooting: 82, passing: 74, dribbling: 82, defending: 42, physical: 72, price: 60000000 },
  { id: 341, name: 'Matheus Cunha', club: 'Man United', position: 'ST', age: 26, ovr: 81, pace: 80, shooting: 78, passing: 74, dribbling: 82, defending: 42, physical: 78, price: 55000000 },
  { id: 342, name: 'Benjamin Sesko', club: 'Man United', position: 'ST', age: 22, ovr: 79, pace: 82, shooting: 78, passing: 60, dribbling: 72, defending: 36, physical: 82, price: 55000000 },
  { id: 343, name: 'Marc Guehi', club: 'Crystal Palace', position: 'CB', age: 25, ovr: 82, pace: 78, shooting: 44, passing: 68, dribbling: 58, defending: 85, physical: 82, price: 40000000 },
  { id: 344, name: 'Adam Wharton', club: 'Crystal Palace', position: 'CM', age: 21, ovr: 78, pace: 72, shooting: 66, passing: 78, dribbling: 76, defending: 70, physical: 70, price: 35000000 },
  { id: 345, name: 'Rico Henry', club: 'Brentford', position: 'LB', age: 27, ovr: 78, pace: 82, shooting: 50, passing: 68, dribbling: 68, defending: 78, physical: 74, price: 20000000 },
]
